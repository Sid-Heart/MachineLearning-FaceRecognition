...
def train(train_dir, model_save_path=None, n_neighbors=None, knn_algo='ball_tree', verbose=False):
    ...
    # Determine how many neighbors to use for weighting in the classifier
...
def predict(X_img_path, knn_clf=None, model_path=None, distance_threshold=0.6):
    ...
    if knn_clf is None and model_path is None:
        raise Exception("Must supply classifier either thourgh knn_clf or model_path")
...
if __name__ == "__main__":
    ...
    classifier = train("train", model_save_path="trained_model.dat", n_neighbors=2)
    ...
    for image_file in os.listdir("test"):
        ...
        predictions = predict(full_file_path, model_path="trained_knn_model.dat")
